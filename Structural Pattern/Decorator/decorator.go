...
// possible, but not generic enough 不够通用
...
func main() {
	...
	//Circle of radius 2.000000

	redCircle := ColoredShape{&circle, "Red"}
	fmt.Println(redCircle.Render())
	//Circle of radius 2.000000 has the color Red

	rhsCircle := TransparentShape{&redCircle, 0.5}
	fmt.Println(rhsCircle.Render())
	//Circle of radius 2.000000 has the color Red has 50.000000 transparency
