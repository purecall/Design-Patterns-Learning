...
func main() {
	...
	fmt.Println(ok)
	/*
		The huge problem is that the test is dependent upon data
		from a real life database.
		But they are `magic numbers` because the database can change at any time.

		In fact, you are not testing the sum up of the cities and their populations
		but you're also testing `the database reads correctly`

		So, you should test the GetPopulation function instead of testing reading databse
		You can use DummyDatabase
	*/
